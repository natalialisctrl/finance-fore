    ...
    <div className="space-y-8">
      ...
      <div className="foresee-card bg-black/40 backdrop-blur-xl border-white/10 p-6 glow-border relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-3 left-6 w-1 h-1 bg-green-400 rounded-full animate-ping"></div>
          <div className="absolute top-8 right-10 w-1 h-1 bg-emerald-300 rounded-full animate-pulse delay-500"></div>
          <div className="absolute bottom-6 left-16 w-1 h-1 bg-green-400 rounded-full animate-ping delay-1000"></div>
        </div>
        <div className="flex items-center justify-between mb-6 relative z-10">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-to-br from-green-500 via-emerald-400 to-teal-300 rounded-2xl flex items-center justify-center shadow-2xl border border-white/20 relative">
              <Brain className="w-6 h-6 text-white" />
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-green-400 to-emerald-300 rounded-full animate-pulse border border-white/50"></div>
            </div>
            <div>
        ...
        <div className="space-y-6 relative z-10">
          ...
          <div className="bg-black/30 backdrop-blur-md border border-green-400/30 p-6 rounded-2xl relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 relative z-10">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-400 rounded-xl flex items-center justify-center relative">
            ...
            <div className="w-full bg-black/50 rounded-full h-4 border border-white/20 mb-3 relative overflow-hidden">
              <div className="bg-gradient-to-r from-green-500 via-emerald-400 to-teal-300 h-4 rounded-full shadow-2xl relative" style={{width: '35%'}}>
          ...
          <div className="bg-black/30 backdrop-blur-md border border-blue-400/30 p-6 rounded-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-400/5 to-transparent animate-pulse"></div>
            <div className="flex justify-between items-center mb-4 relative z-10">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-xl flex items-center justify-center relative">
            ...
            <div className="w-full bg-black/50 rounded-full h-4 border border-white/20 mb-3 relative overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 via-cyan-400 to-teal-300 h-4 rounded-full shadow-2xl relative" style={{width: '24%'}}>
                <div className="absolute inset-0 bg-white/20 animate-pulse rounded-full"></div>
              </div>
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-pulse"></div>
            </div>
      ...
      <div className="foresee-card bg-black/40 backdrop-blur-xl border-white/10 p-6 glow-border-gold relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-4 left-8 w-1 h-1 bg-red-400 rounded-full animate-ping"></div>
          <div className="absolute top-10 right-12 w-1 h-1 bg-orange-300 rounded-full animate-pulse delay-700"></div>
          <div className="absolute bottom-8 left-20 w-1 h-1 bg-red-400 rounded-full animate-ping delay-1500"></div>
        </div>
